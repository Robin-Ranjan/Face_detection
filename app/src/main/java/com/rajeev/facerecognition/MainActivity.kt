package com.rajeev.facerecognition
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 123 && resultCode == RESULT_OK) {
            ...
            val extraData = data?.extras
            val bitMap = extraData?.get("data") as? Bitmap
            if (bitMap != null) {
                detectFace(bitMap)
            }
        }
                ...
                .addOnSuccessListener { faces->
                    ...
                    for(face in faces){
                        resultText = "Face Number: $i" +
                                ...
                                "\nLeft Right Open: ${face.rightEyeOpenProbability?.times(100)}%"
                        i++
                    }
                    if(faces.isEmpty()){
